...
type SumAccountFromUsernameParams struct {
	Name         string
	OccurredAt   int64
	OccurredAt_2 int64
}
...
func (q *Queries) SumAccountFromUsername(ctx context.Context, arg SumAccountFromUsernameParams) ([]SumAccountFromUsernameRow, error) {
	rows, err := q.db.QueryContext(ctx, sumAccountFromUsername, arg.Name, arg.OccurredAt, arg.OccurredAt_2)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) SumAccountTxnFromNames(ctx context.Context, arg SumAccountTxnFromNamesParams) (sql.NullFloat64, error) {
	row := q.db.QueryRowContext(ctx, sumAccountTxnFromNames,
		arg.Name,
		arg.Name_2,
		arg.OccurredAt,
		arg.OccurredAt_2,
